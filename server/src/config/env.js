...
const env = {
  ...
  AUTH_RATE_LIMIT_MAX_REQUESTS: process.env.AUTH_RATE_LIMIT_MAX_REQUESTS || 60,
  AUTH_OTP_RATE_LIMIT_MAX_REQUESTS: process.env.AUTH_OTP_RATE_LIMIT_MAX_REQUESTS || 10,
};
