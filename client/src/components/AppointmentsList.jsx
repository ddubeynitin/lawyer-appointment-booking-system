...
export default function AppointmentsList() {
  ...
  const filteredAppointments = useMemo(() => {
    return appointments.filter((appointment) => {
      ...
      // Search filter - search by lawyer name, user info, case category
    ...
    <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search by lawyer name, case category, description..."
            value={searchQuery}
        ...
        <div className="relative">
          <select
            ...
            className="pl-4 pr-8 py-2 text-sm border border-gray-200 rounded-lg hover:border-blue-500 hover:ring-2 hover:ring-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition appearance-none bg-white cursor-pointer"
          >
